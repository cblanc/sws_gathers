...
import { Gather, GatherMenu } from "./gather";
import { InfoButton } from "./info";
import { AdminPanel } from "./admin";
import { Chatroom } from "./message";
import { SoundPanel } from "./sound";
import { ArchivedGathers } from "./gatherArchive";
import { CurrentUser, ProfileModal, UserMenu } from "./user";
...
class AuthFailedSplash extends React.Component {
  render() {
    return (
...
class BannedSplash extends React.Component {
  render() {
    return (
      <div className="row">
        <div className="col-lg-6 col-lg-offset-3">
...
class GatherPage extends React.Component {
  static propTypes = {
  ...
  currentGather = () => this.state.gatherPool[this.state.currentGather]
  ...
  modal = () => {
    ...
    return (
      <div className="modal fade in" style={{ display: "block" }}>
        <Comp {...options.props} close={this.closeModal} />
      </div>
    );
  }
