...
Gather.prototype.pickingTurn = function () {
	...
	const numberOfCaptains = 2;
	const alreadyInTeamsCount = marineCount + alienCount;
	const pickingTurn = alreadyInTeamsCount - numberOfCaptains;
	const defaultTurns = [ // 1-1-1-2-1-1-2-1
		"marine",
		"alien",
		"marine",
		"alien",
	...
	if (this.hasCustomPickingSystem()) {
		return this.getCustomPickingSystemTurn(pickingTurn);
	}

	return defaultTurns[pickingTurn];
};
